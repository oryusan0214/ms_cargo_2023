...
uint16_t ang_min[SERVO_MAX] = {115,40,65,  125,0,80,   125,40,44,  120,10,45,  125,5,75,   115,10,60};
uint16_t ang_max[SERVO_MAX] = {180,82,145, 180,37,110, 180,82,120, 180,50,120, 180,35,105, 180,43,132};
uint16_t ang_ini[SERVO_MAX] = {140,70,130, 140,35,95,  145,70,65,  140,35,60,  140,35,90,  125,35,115};
